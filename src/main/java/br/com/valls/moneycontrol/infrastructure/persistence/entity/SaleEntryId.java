...
/**
 * Chave composta para {@link SaleEntryJpaEntity}.
 * Necessária porque a tabela sale_entries é particionada por iso_year
...
public class SaleEntryId implements Serializable {
    ...
    public SaleEntryId(UUID id, int isoYear) {
        this.id      = id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SaleEntryId that)) return false;
